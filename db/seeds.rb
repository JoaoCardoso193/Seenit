...
u1 = User.create(user_name: 'Joao', password: '12345', password_confirmation: '12345')
u2 = User.create(user_name: 'Eric', password: '12345', password_confirmation: '12345')
u3 = User.create(user_name: 'Anmolpreet', password: '12345', password_confirmation: '12345')
u4 = User.create(user_name: 'Seenit_Bot', password: '12345', password_confirmation: '12345')
